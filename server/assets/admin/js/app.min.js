...
var Apps_1 = require('./services/Apps');
var Servers_1 = require('./services/Servers');
...
angular.module('2Q2R', [
    ...
    .service('Auth', Auth_1.Auth)
    .service('Apps', Apps_1.Apps)
    .service('Servers', Servers_1.Servers)
...
},{"./controllers/AdminsCtrl":2,"./controllers/AppsCtrl":3,"./controllers/LoginCtrl":4,"./controllers/MainCtrl":5,"./controllers/ServersCtrl":6,"./controllers/modals/AddAppCtrl":7,"./controllers/modals/AddServerCtrl":8,"./services/Apps":10,"./services/Auth":11,"./services/Servers":12}],2:[function(require,module,exports){
"use strict";
...
},{"../controllers/modals/AddAppCtrl":7}],4:[function(require,module,exports){
"use strict";
...
var MainCtrl = (function () {
    function MainCtrl($mdSidenav, $state, $mdDialog, Auth) {
...
},{"./modals/GenerateCtrl":9}],6:[function(require,module,exports){
"use strict";
var _ = require('lodash');
var AddServerCtrl_1 = require('./modals/AddServerCtrl');
var ServersCtrl = (function () {
    ...
    ServersCtrl.prototype.selectApp = function (app) {
    ...
    ServersCtrl.prototype.newServer = function () {
        var _this = this;
        this.$mdDialog.show({
            controller: AddServerCtrl_1.AddServerCtrl,
            controllerAs: 'cMod',
    ...
    ServersCtrl.prototype.refresh = function () {
        var _this = this;
        this.apps = this.App.query();
        this.servers = this.Server.query(function () {
            _this.serversByAppID = _.groupBy(_this.servers, 'appID');
        });
    };
    ServersCtrl.$inject = [
        '$mdDialog',
...
},{"./modals/AddServerCtrl":8,"lodash":13}],7:[function(require,module,exports){
"use strict";
        ...
        for (var i = 0; i < this.numApps; i++) {
            ...
            app.$save().then(function (newApp) {
                ...
                for (var j = 0; j < numS; j++) {
                    var server = new _this.Server({
                        appID: appID,
                        serverName: _this.serverPrefix + " " + _this.appPrefix + " " + sNum
                    });
                    server.$save();
                    sNum++;
                }
